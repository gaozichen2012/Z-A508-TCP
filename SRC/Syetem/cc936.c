...
wchar_t ff_convert (	/* Converted code, 0 means conversion error */
	wchar_t	chr,	/* Character code to be converted */
...
wchar_t ff_wtoupper (	/* Returns upper converted character */
	wchar_t chr		/* Unicode character to be upper converted (BMP only) */
)
{
